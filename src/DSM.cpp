...
thread_local int TestDSM::thread_id = -1;
thread_local ThreadConnection *TestDSM::iCon = nullptr;
thread_local char *TestDSM::rdma_buffer = nullptr;
thread_local LocalAllocator TestDSM::local_allocators[MEMORY_NODE_NUM][NR_DIRECTORY];
thread_local TestBuffer TestDSM::rbuf[MAX_CORO_NUM];
thread_local uint64_t TestDSM::thread_tag = 0;

//Test
TestDSM *TestDSM::getInstance(const DSMConfig &conf) {
  static TestDSM *dsm = nullptr;
  static WRLock lock;

  lock.wLock();
  if (!dsm) {
    dsm = new TestDSM(conf);
  } else {
  }
  lock.wUnlock();
...
TestDSM::TestDSM(const DSMConfig &conf)
...
TestDSM::~TestDSM() { hugePageFree((void *)baseAddr, conf.dsmSize * define::GB); }

void TestDSM::registerThread() {
...
void TestDSM::loadKeySpace(const std::string& load_workloads_path, bool is_str) {
  keySpaceSize = 0;
...
void TestDSM::read(char *buffer, GlobalAddress gaddr, size_t size, bool signal,
               CoroContext *ctx) {
  if (ctx == nullptr) {
...
void TestDSM::read_sync(char *buffer, GlobalAddress gaddr, size_t size,
                    CoroContext *ctx) {
...
void TestDSM::write(const char *buffer, GlobalAddress gaddr, size_t size,
...
void TestDSM::write_sync(const char *buffer, GlobalAddress gaddr, size_t size,
                     CoroContext *ctx) {
...
void TestDSM::fill_keys_dest(RdmaOpRegion &ror, GlobalAddress gaddr, bool is_chip) {
...
void TestDSM::read_batch(RdmaOpRegion *rs, int k, bool signal, CoroContext *ctx) {
...
void TestDSM::read_batch_sync(RdmaOpRegion *rs, int k, CoroContext *ctx) {
...
void TestDSM::read_batches_sync(const std::vector<RdmaOpRegion>& rs, CoroContext *ctx, int coro_id) {
...
void TestDSM::write_batch(RdmaOpRegion *rs, int k, bool signal, CoroContext *ctx) {
...
void TestDSM::write_batch_sync(RdmaOpRegion *rs, int k, CoroContext *ctx) {
...
void TestDSM::write_batches_sync(RdmaOpRegion *rs, int k, CoroContext *ctx, int coro_id) {
...
void TestDSM::write_faa(RdmaOpRegion &write_ror, RdmaOpRegion &faa_ror,
...
void TestDSM::write_faa_sync(RdmaOpRegion &write_ror, RdmaOpRegion &faa_ror,
...
void TestDSM::write_cas(RdmaOpRegion &write_ror, RdmaOpRegion &cas_ror,
...
void TestDSM::write_cas_sync(RdmaOpRegion &write_ror, RdmaOpRegion &cas_ror,
...
void TestDSM::cas_read(RdmaOpRegion &cas_ror, RdmaOpRegion &read_ror,
                   uint64_t equal, uint64_t val, bool signal,
                   CoroContext *ctx) {
  int node_id;
  {
...
void TestDSM::read_cas(RdmaOpRegion &read_ror, RdmaOpRegion &cas_ror,
                   uint64_t equal, uint64_t val, bool signal,
                   CoroContext *ctx) {
  int node_id;
  {
...
bool TestDSM::cas_read_sync(RdmaOpRegion &cas_ror, RdmaOpRegion &read_ror,
                        uint64_t equal, uint64_t val, CoroContext *ctx) {
...
bool TestDSM::read_cas_sync(RdmaOpRegion &read_ror, RdmaOpRegion &cas_ror,
                        uint64_t equal, uint64_t val, CoroContext *ctx) {
...
void TestDSM::cas_write(RdmaOpRegion &cas_ror, RdmaOpRegion &write_ror,
                    uint64_t equal, uint64_t val, bool signal,
                    CoroContext *ctx) {
  int node_id;
  {
...
bool TestDSM::cas_write_sync(RdmaOpRegion &cas_ror, RdmaOpRegion &write_ror,
                         uint64_t equal, uint64_t val, CoroContext *ctx) {
...
void TestDSM::two_cas(RdmaOpRegion &cas_ror_1, uint64_t equal_1, uint64_t val_1,
  ...
  if (ctx == nullptr) {
    rdmaTwoCas(iCon->data[0][node_id], cas_ror_1, equal_1, val_1, cas_ror_2,
               equal_2, val_2, signal);
  } else {
    rdmaTwoCas(iCon->data[0][node_id], cas_ror_1, equal_1, val_1, cas_ror_2,
               equal_2, val_2, true, ctx->coro_id);
    (*ctx->yield)(*ctx->master);
  }
}

std::pair<bool, bool> TestDSM::two_cas_sync(RdmaOpRegion &cas_ror_1, uint64_t equal_1, uint64_t val_1, 
                                        RdmaOpRegion &cas_ror_2, uint64_t equal_2, uint64_t val_2,
                                        CoroContext *ctx) {
...
void TestDSM::cas(GlobalAddress gaddr, uint64_t equal, uint64_t val,
...
bool TestDSM::cas_sync(GlobalAddress gaddr, uint64_t equal, uint64_t val,
...
void TestDSM::read_dm(char *buffer, GlobalAddress gaddr, size_t size, bool signal,
                  CoroContext *ctx) {
...
void TestDSM::read_dm_sync(char *buffer, GlobalAddress gaddr, size_t size,
                       CoroContext *ctx) {
...
void TestDSM::write_dm(const char *buffer, GlobalAddress gaddr, size_t size,
                   bool signal, CoroContext *ctx) {
  if (ctx == nullptr) {
    rdmaWrite(iCon->data[0][gaddr.nodeID], (uint64_t)buffer,
              remoteInfo[gaddr.nodeID].lockBase + gaddr.offset, size,
...
void TestDSM::write_dm_sync(const char *buffer, GlobalAddress gaddr, size_t size,
                        CoroContext *ctx) {
...
void TestDSM::cas_dm(GlobalAddress gaddr, uint64_t equal, uint64_t val,
                 uint64_t *rdma_buffer, bool signal, CoroContext *ctx) {
...
bool TestDSM::cas_dm_sync(GlobalAddress gaddr, uint64_t equal, uint64_t val,
                      uint64_t *rdma_buffer, CoroContext *ctx) {
...
uint64_t TestDSM::poll_rdma_cq(int count) {
  ibv_wc wc;
...
bool TestDSM::poll_rdma_cq_once(uint64_t &wr_id) {
  ibv_wc wc;
...
int TestDSM::poll_rdma_cq_batch_once(uint64_t *wr_ids, int count) {
